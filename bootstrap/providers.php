...
return [
    ...
    Bitrio\Wompi\Providers\WompiServiceProvider::class,
    Bitrio\CityDelivery\Providers\CityDeliveryServiceProvider::class,
    Bitrio\CityCoverageShippingMethod\Providers\CityCoverageShippingMethodServiceProvider::class,
